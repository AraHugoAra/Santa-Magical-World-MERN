...
export default function Toy() {
  ...
  const { data, error, loading } = useFetch(
    `http://localhost:3001/toys/${toyId}`
  );

  return (
    <>
      <Typography sx={{ my: 4 }} align="center" variant="h2">
      ...
      {loading || error ? (
        ...
        <>
          ...
          <TableContainer component={Paper}>
            <Table
              align="center"
              sx={{ minWidth: 650, maxWidth: 1250 }}
              aria-label="toys table"
            >
              <TableHead>
                <TableRow>
