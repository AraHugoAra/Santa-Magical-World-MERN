      ...
      {loading || error ? (
        ...
        >
          <FormControl>
            ...
            <Input
              id="nameInput"
              aria-describedby="new-toy-name-input"
          ...
          <FormControl>
            ...
            <Input
              id="descriptionInput"
              aria-describedby="new-toy-description-input"
          ...
          <FormControl>
            ...
            <Input
              id="priceInput"
              aria-describedby="new-toy-price-input"
              onChange={(e) => handlePriceInput(e)}
            />
          </FormControl>
          <Button variant="outlined" size="large" color="inherit" type="submit">
            Add New Toy
          </Button>
        </Container>
      )}
